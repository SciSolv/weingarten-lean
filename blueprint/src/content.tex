...
positive-only set printed there implicitly carries the nonnegativity
qualification made explicit here; the same paper displays the rising sum rule
...
positive-only set printed in arXiv:2510.21186 therefore carries the same
nonnegativity qualification adopted here --- its own display~(3.2) and
sign-twist symmetry confirm the band. The formalized content of this node
